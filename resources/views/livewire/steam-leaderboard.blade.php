            ...
            @if(count($rankings) > 0)
                ...
                @else
                    <div class="text-center py-8">
                        <p class="text-gray-400 mb-2">No maps with world records found</p>
                        <p class="text-gray-500 text-sm">Turn off "Show only maps with world records" to see all available leaderboards</p>
                    </div>
                @endif
            @else
                <div class="text-center py-8">
