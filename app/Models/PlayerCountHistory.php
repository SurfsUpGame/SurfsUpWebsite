...
class PlayerCountHistory extends Model
{
    ...
    public static function getHistoryForLast72Hours(string $appId = '3454830'): \Illuminate\Database\Eloquent\Collection
    {
        return self::where('app_id', $appId)
    ...
    public static function getChartDataForLast72Hours(string $appId = '3454830'): array
    {
        $history = self::getHistoryForLast72Hours($appId);
